  ...
  <div class="border border-gray-200 p-3 mb-4 rounded">
    ...
    <div v-show="showForm">
      ...
      <vee-form :validation-schema="schema" :initial-values="song" @submit="edit">
        ...
        <button @click.prevent="showForm = !showForm" type="button" class="py-1.5 px-3 rounded text-white bg-gray-600" :disabled="inSubmission">
          Go Back
        </button>
      </vee-form>
    </div>
...
export default {
  ...
  data() {
    return {
      showForm: false,
      schema: {
        modifiedName: 'modifiedSong',
        genre: 'alphaSpaces',
      },
      inSubmission: false,
      showAlert: false,
      alertVariant: 'bg-blue-500',
      alertMessage: 'Please wait. Updating the song info!',
    };
  },
  methods: {
    async edit(values) {
      ...
      this.alertMessage = 'Please wait. Updating the song info!';
      try {
      ...
      this.alertMessage = 'Data Modified Successfully!';
